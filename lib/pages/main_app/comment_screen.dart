...
import 'package:student_net/blocs/comment/comment_bloc.dart';
import 'package:student_net/blocs/post/post_bloc.dart';
import 'package:student_net/services/constants.dart';
import 'package:student_net/models/post/comment_model.dart';
import 'package:student_net/models/post/post_model.dart';
import 'package:student_net/repositories/comment_repository.dart';
import 'package:student_net/models/post/format_time.dart';
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Text(
                  ' ${(post.like == "1" && post.isLiked == "1") ? authUser != null : (int.parse(post.like!) < 100 && post.isLiked == "1") ? "Bạn và ${int.parse(post.like!) - 1} người khác" : post.like}'),
            ],
          ),
          Row(
            children: <Widget>[
